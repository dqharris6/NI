...
# pmi <-file.path(bigDataDirRoot,"QuarterlyPMI_01apr16.csv")
# bDat <-file.path(bigDataDirRoot,"bDat.txt")
# bDatwoNAPA <-file.path(bigDataDirRoot,"bDatwoNAPA.txt")

# bDat <- RxTextData(file = file.path(bigDataDirRoot,"bDat.txt"), fileSystem = hdfsFS, missingValueString = "NA")
# bDatwoNAPA <- RxTextData(file.path(bigDataDirRoot,"bDatwoNAPA.txt"), fileSystem = hdfsFS, missingValueString = "NA")
# pmi <- RxTextData(file = file.path(bigDataDirRoot,"QuarterlyPMI_01apr16.csv"), fileSystem = hdfsFS, missingValueString = "NA")
...
results <- rxExec(runForecasts, execObjects = "forecastResults")
...
# rxHadoopCopyFromLocal("results.txt", dest = "adl://aapocdls.azuredatalakestore.net/dalton_test")
