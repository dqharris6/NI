...
inputfile_bDatwoNAPA <- file.path(bigDataDirRoot,"bDatwoNAPA_00000.csv")
bDatwoNAPA_text <- RxTextData(file = inputfile_bDatwoNAPA, missingValueString = "NA", fileSystem = hdfsFS)
...
# Data target: Hive (primary blob storage)

write.csv(results, file="results.csv")
rxHadoopCopyFromLocal("results.csv", dest = "https://hdiaapocblob.blob.core.windows.net/hdiaapochdi/hive/warehouse/forecast.db/results/results.csv")
